ViridianGymObject:
	...
	db 11 ; objects
	object SPRITE_GIOVANNI, 2, 1, STAY, DOWN, 1, OPP_GIOVANNI2, 3
	object SPRITE_BLACK_HAIR_BOY_1, 12, 7, STAY, DOWN, 2, OPP_COOLTRAINER_M, 9
	object SPRITE_BLACKBELT, 11, 11, STAY, UP, 3, OPP_BLACKBELT, 6
	object SPRITE_ROCKER, 10, 7, STAY, DOWN, 4, OPP_TAMER, 3
	object SPRITE_BLACKBELT, 3, 7, STAY, LEFT, 5, OPP_BLACKBELT, 7
	object SPRITE_BLACK_HAIR_BOY_1, 13, 5, STAY, RIGHT, 6, OPP_COOLTRAINER_M, 10
	object SPRITE_BLACKBELT, 10, 1, STAY, DOWN, 7, OPP_BLACKBELT, 8
