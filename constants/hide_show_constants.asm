...
const_value = 0
	...
	const HS_UNKNOWN_DUNGEON_2_FOSSIL_1   ; D1
	const HS_UNKNOWN_DUNGEON_2_FOSSIL_2   ; D2
	const HS_MEWTWO                       ; D3 X
	const HS_UNKNOWN_DUNGEON_3_ITEM_1     ; D4 X
	const HS_UNKNOWN_DUNGEON_3_ITEM_2     ; D5 X
	const HS_VICTORY_ROAD_1_ITEM_1        ; D6 X
	const HS_VICTORY_ROAD_1_ITEM_2        ; D7 X
	...
	const HS_SEAFOAM_ISLANDS_5_BOULDER_1  ; E3
